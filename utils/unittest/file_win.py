...
if __name__ == "__main__":
    ...
    # # 上传文件夹
    # local_item = 'C:\\Users\\zym\\Desktop\\zlib'  # 可以是文件或文件夹
    # remote_item = '/home/zym/container/'  # 远程位置
    # file_transfer.upload(local_item, remote_item)

    # # 上传文件
    # local_item = 'C:\\Users\\zym\\Desktop\\mytest.txt'  # 可以是文件或文件夹
    # remote_item = '/home/zym/container/'  # 远程位置
    # file_transfer.upload(local_item, remote_item)

    # # 下载文件
    # local_item = 'C:\\Users\\zym\\Desktop'  # 可以是文件或文件夹
    # remote_item = '/home/zym/container/zlib/docker-compose.yml'  # 远程位置
    # file_transfer.download(remote_item, local_item)

    # 下载文件夹
    local_item = 'C:\\Users\\zym\\Desktop'  # 可以是文件或文件夹
    remote_item = '/home/zym/container/zlib/libs'  # 远程位置
    file_transfer.download(remote_item, local_item)